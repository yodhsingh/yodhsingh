...
| [Malware Detection](https://github.com/yodhsingh/classification) | A malware classification pipeline built using more than 100,000 samples and over 180 features, focusing on preprocessing, model evaluation, cross-validation, and classification performance. | Python, Scikit-learn, XGBoost |
...
| Machine Learning & Data | NumPy, Pandas, Matplotlib, Scikit-learn, PyTorch, TensorFlow |
| Generative AI & NLP     | Transformers, GPT, LLaMA, Prompt Engineering, RAG            |
| Web Development         | Flask, FastAPI, React, Vue.js, Tailwind CSS                  |
| Databases & Tools       | PostgreSQL, SQLAlchemy, Redis, Celery                        |
...
Bachelor of Science in Data Science and Applications · September 2022–Present
**CGPA:** 8.5/10

Completed Diplomas in Programming and Data Science.

**Relevant coursework:** Deep Learning, Computer Vision, Large Language Models, Software Engineering, Mathematics for Generative AI, Deep Learning with PyTorch, AI Search Methods, Linear Algebra, Calculus, Graph Theory, and Statistics.
